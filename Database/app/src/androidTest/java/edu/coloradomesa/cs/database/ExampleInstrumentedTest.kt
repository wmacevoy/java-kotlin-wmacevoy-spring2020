...
fun testExposed() {
    //Database.connect("jdbc:h2:mem:test", driver = "org.h2.Driver", user = "postgres", password = "")
    Database.connect("jdbc:postgresql:testdb", driver="org.postgresql.Driver", user = "postgress", password = "wrong")
    transaction {
...
class ExampleInstrumentedTest {
    ...
    fun useAppContext() {
        ...
        assertEquals("edu.coloradomesa.cs.database", appContext.packageName)
    }
